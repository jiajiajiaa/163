    ...
    <div class="reco-list" v-if="homeData.popularItemList">
      <div class="reco-list-top">
        ...
        <div class="good-info">
          ...
          <p class="ellipsis">{{homeData.popularItemList[0].simpleDesc}}</p>
          <p>￥{{homeData.popularItemList[0].counterPrice}}</p>
        </div>
      </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      getPopularItem () {
        return [...this.homeData.popularItemList].splice(1, 4);
      }
    }
  }
</script>
